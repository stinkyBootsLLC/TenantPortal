        ...
        <div class="container">
            ...
            <?php 
                ...
                if(isset($_SESSION['app_userEmail']) && isset($_SESSION['app_pass'])){
                    ...
                    echo "<label for='issue id'>Issue ID:</label>";
                    echo "<input class='form-control' type='text' id='issueID' name='id' value=".$id." readonly>";
                    echo "<label for='Reported'>Reported:</label><input class='form-control' type='date' id='IssueReportDate' name='IssueReportDate' value=".$IssueReportDate." readonly>";
                    echo "<label for='Priority'>Priority:</label><select class='form-control' name='IssuePriority'>";
                    echo "<option value=".$IssuePriority.">".$IssuePriority."</option>";
                    echo "<option value='High'>High</option>";
                    echo "<option value='Medium'>Medium</option>";
                    echo "<option value='Low'>Low</option>";
                    echo "</select>"; 
                    echo "<label for='Status'>Status:</label><select class='form-control' name='IssueStatus'>";
                    ...
                    echo "<label for='Scheduled'>Scheduled:</label> <input class='form-control' type='date' name='ScheduledDate' value=".$ScheduledDate.">";
                    echo "<label for='Repaired'>Repaired:</label> <input class='form-control' type='date' name='IssueRepairDate' value=".$IssueRepairDate.">";
                    echo "<label for='Repair Price'> Repair Price:</label> <input class='form-control' type='text' name='IssueRepairPrice' value=".$IssueRepairPrice."><br>";
                  
                    echo "</fieldset>";
                    // tenant name field
                    echo "<fieldset class='form-group'>";
                    echo "<label for='Tenant Name'>Tenant Name:</label>";
                    echo "<input class='form-control' type='text' name='tenantName' id='Tenant Name' value=".$tenantName." readonly><br>";
                    echo "</fieldset>";
